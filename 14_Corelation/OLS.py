# -*- coding: utf-8 -*-
"""
Created on Wed Feb 21 15:34:57 2024
...
plt.legend(['Actual data','predicted data model 2'])
plt.show()
## Error calculations
res2=wcat.AT-pred2
res_sqr2=res2*res2
...
plt.legend(['predicted line','obserrved data'])
plt.show()
# Error calculations
...
##########################################
data={"model":pd.Series(['SLR','log_model','Exp_Mmodel','Poly_model'])}
data
