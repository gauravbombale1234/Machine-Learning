...
# Data Dictionary
data_={
    'Name_of_feature':['Unnamed ', 'Murder', 'Assault', 'UrbanPop', 'Rape'],
    'Discription':['Unnamed: 0', 'Murder', 'Assault', 'UrbanPop', 'Rape'],
    'Type':['Nominal','Quantitative','Quantitative','Quantitative','Quantitative'],
    'Relevance':['Irrelevance','Relevance','Relevance','Relevance','Relevance']
    
    }

data_dict=pd.DataFrame(data_)
data_dict
