# -- coding: utf-8 --
"""
Created on Mon Mar  4 15:12:38 2024

@author: Gaurav Bombale

Predicting the new values based on the old values
"""
import pandas as pd
...
predict_data = pd.read_excel("C:/16_Time Series/Predict_new.xlsx")
...
tsa_plots.plot_acf(full_res, lags=12)    #6 Rk values are greater
#ACF is an (complete) autocorelation function gives values 
